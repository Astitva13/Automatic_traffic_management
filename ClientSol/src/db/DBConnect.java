...
public class DBConnect {
    ...
    public static PreparedStatement AddClient,GetClient,UpdateClient;
    ...
    static{
        ...
        Class.forName("com.mysql.jdbc.Driver");
           ...
           UpdateClient= c.prepareStatement("update client_info set name=?,gender=?,dob=?,country=?,address=?,languages=?  where cid=?");
